...
kernelspec:
  ...
  language: python
  name: python3
landing: '2024-09-16 19:33:00Z'
orphan: true
platform: HALO
takeoff: '2024-09-16 10:33:00Z'
---
...
aircraft = "HALO"
flight_time = datetime(2024, 9, 19, 10, 33, 0)
...
circ_3 = pace_start.towards(airport, distance = radius).assign(label="c3") #centre_from_tangent(meteor, pace_start, atr_radius, 0).assign(label="c3")
circ_3_atr = pace_start.towards(airport, distance = atr_radius).assign(label="c3_atr")
...
circ_5 = ec_end.towards(airport, distance= radius).assign(label="c5")
...
waypoints = [
    ...
    IntoCircle(circ_3_atr.assign(fl=fl3), atr_radius,  angle=-360), # ANTI-CLOCKWISE
    ...
    IntoCircle(circ_5.assign(fl=fl3), radius,  angle=-360), # anti-clockwise (optional)
    airport.assign(fl=0),
]
