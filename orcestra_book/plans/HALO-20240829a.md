...
c_north_alt = LatLon(lat_c_north_alt, find_ec_lon(lat_c_north_alt, ec_lons, ec_lats), label = "c_north_alt")
...
extra_waypoints = [xwp_2,xwp_3,c_north_alt]
